...
const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    'project.sanjorge.desc': 'Tienda online de insumos de computación con catálogo completo, carrito de compras y pago online.',
  ...
  en: {
    ...
    'project.sanjorge.desc': 'Online store for computer supplies with a full catalog, shopping cart and online payment.',
  ...
  pt: {
    ...
    'project.sanjorge.desc': 'Loja online de insumos de informática com catálogo completo, carrinho de compras e pagamento online.',
